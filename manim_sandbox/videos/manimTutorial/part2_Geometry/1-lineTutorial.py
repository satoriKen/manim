...
class Line_tutorial(Scene):
    ...
    def construct(self):
        ...
        text = VGroup(*[CodeLine(obj, size=0.32, font="Source Han Sans CN Bold") for obj in text_list])
        ...
        self.wait(3)
        self.play(ReplacementTransform(text[2], text[3]), FadeOut(code[0]), Write(code[1]))
        self.play(ReplacementTransform(l_1, l_2), Write(dot_0_g))
        self.wait(2.5)
        ...
        self.play(ReplacementTransform(text[3], text[4]), FadeOut(code[1]), FadeIn(code[2]), FadeIn(rect_0))
        ...
        self.wait(2.5)
        self.play(ReplacementTransform(text[4], text[5]), FadeOut(code[2]), FadeIn(code[3]))
        l_2.add_updater(lambda l: l.become(
...
class Line_tutorial_2(Scene):
    ...
    def construct(self):
      ...
      path_arc=None)""",
        ...
        text = VGroup(*[CodeLine(obj, font="Source Han Sans CN Bold") for obj in text_list]).to_edge(DOWN * 1.2)
        self.add(axes, bg_rect, code[0], text[0], dot_0_g, l_2)
        self.play(ReplacementTransform(text[0], text[1]), FadeOut(code[0]), FadeIn(code[1]))
        ...
        self.wait(2.5)
        self.play(ReplacementTransform(text[1], text[2]), Write(code[2]))
        self.play(l_2.scale, 3)
        self.play(l_2.scale, 1 / 3, ReplacementTransform(code[2], code[-1]))
        self.wait(2)
        l_3 = DashedLine(np.array([-2, -2, 0]), np.array([0, 2, 0]), color=PURPLE)
        self.play(FadeOut(dot_0_g), ReplacementTransform(text[2], text[3]))
        ...
        self.play(ReplacementTransform(text[3], text[4]), Write(code[4]), ShowCreation(l_4))
...
class ArrowTutorial(Scene):
    ...
    def construct(self):
        ...
        self.play(ReplacementTransform(text[0], text[1]), FadeInFromLarge(bg_rect))
...
class VectorTutorial(Scene):
    ...
    def construct(self):
      ...
      np.array([-1,0,0]))""",
        ...
        self.wait(1.5)
        self.play(ReplacementTransform(text[0], text[1]), Write(code[0]))
        self.play(ShowCreation(vec_1))
        self.wait(3)
        self.play(ReplacementTransform(text[1], text[2]), Write(code[1]))
        self.play(vec_1.shift, UP * 2 + LEFT * 1)
        self.wait(2)
        self.play(ReplacementTransform(text[2], text[3]), Write(code[2]))
        self.play(ShowCreation(vec_2))
        self.wait(2)
        self.play(ReplacementTransform(text[3], text[4]), Write(code[3:5]))
        self.play(ShowCreation(arc_1))
        self.wait(2)
        self.play(ReplacementTransform(text[4], text[5]), Write(code[5]))
        self.play(ReplacementTransform(arc_1, arc_2))
        self.wait(2)
        cir = Circle().shift(np.array([-5, -1, 0]))
        line = TangentLine(cir, 0, length=5).set_color(PURPLE)
        self.play(ReplacementTransform(text[5], text[6]), Write(code[6:8]))
