...
class stretch_demo(Scene):
    ...
    def construct(self):
        ...
        # huge word
        stretch = CodeLine("stretch", font='Source Han Sans CN Bold', size=2, plot_depth=4)
        set_h = CodeLine("set_height", font='Source Han Sans CN Bold', size=1, plot_depth=4, color="#7ca761") \
            .move_to(np.array([-3.5, 0, 0])) \
            .save_state() \
            .add_updater(lambda h: h.set_plot_depth(4))
        set_w = CodeLine("set_width", font='Source Han Sans CN Bold', size=1, plot_depth=4, color="#7ca761") \
            .move_to(np.array([3.5, 0, 0])) \
            .save_state() \
