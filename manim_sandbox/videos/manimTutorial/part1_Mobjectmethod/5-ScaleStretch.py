    ...
    def __init__(self, obj, **kwargs):
        ...
        if not self.black_bg:
            border = Rectangle(width=4, height=2).add_updater(
                lambda b: b.become(
                    Rectangle(width=obj.get_width() + 2 * self.buff, height=obj.get_height() + 2 * self.buff,
...
class Stretch_tutorial(ThreeDScene):
    ...
    def construct(self):
        ...
        texts = VGroup(*[CodeLine(text, size=0.32, font="Source Han Sans CN Bold") for text in text_list]) \
            .to_edge(DOWN * 1.2)
        mur0 = SVGMobject(r'mur.svg',
        ...
        self.move_camera(phi=PI / 3, theta=-100)
...
# self.play()后对应的动画过程'''
        ...
        code_last = CodeLine(code_list_1[-1], font="Source Han Sans CN Bold", size=0.32)
...
class Scale_tutorial(Scene):
    ...
    {'scale_factor':0.6,
     'about_edge':LEFT})""",
        ...
        texts = VGroup(*[CodeLine(i, size=0.32, font="Source Han Sans CN Bold")
        ...
        self.wait(2)
        self.play(FadeIn(mur), ReplacementTransform(texts[0], texts[1]), Write(codes[0]))
        self.wait(2)
        self.play(FadeIn(border), ReplacementTransform(texts[1], texts[2]),
        ...
        self.play(ReplacementTransform(texts[2], texts[3]), Write(codes[1]))
        self.play(mur.scale, 2)
        self.wait(2)
        self.play(ReplacementTransform(texts[3], texts[4]), Write(codes[2]))
        self.play(mur.scale, 0.5)
        self.wait(2)
        self.play(ReplacementTransform(texts[4], texts[5]), Write(codes[3]))
        ...
        self.wait(2)
        self.play(ReplacementTransform(texts[5], texts[6]), Write(codes[4]))
        ...
        self.play(ReplacementTransform(texts[6], texts[7]), Write(codes[5]), Write(dot_2), Write(array2),
        ...
        self.play(ReplacementTransform(texts[7], texts[8]), Write(codes[6]))
        self.play(mur.scale, 1.5)
        self.wait(2)
        self.play(ReplacementTransform(texts[8], texts[9]), Write(codes[7]))
