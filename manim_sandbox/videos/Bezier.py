...
class LinearBezierCurve(Scene):
    ...
    def construct(self):
        ...
        label = Text("线性贝塞尔曲线", font="Source Han Serif SC").scale(1.8).set_color(BLACK).shift(DOWN * 3)
        self.add(label)
...
class QuadraticBezierCurve(Scene):
    ...
    def construct(self):
        ...
        label = Text("二次贝塞尔曲线", font="Source Han Serif SC").scale(1.8).set_color(BLACK).shift(DOWN * 3)
        self.add(label)
        self.add(P, P_lines)
        self.add(Q, Q0_Q1)
        self.add(B, path)
...
class CubicBezierCurve(Scene):
    ...
    def construct(self):
        ...
        label = Text("三次贝塞尔曲线", font="Source Han Serif SC").scale(1.8).set_color(BLACK).shift(DOWN * 3)
        self.add(label)
        self.add(P, P_lines)
        self.add(Q, Q_lines)
        self.add(R, R0_R1)
...
class FourthOrderBezierCurve(Scene):
    ...
    def construct(self):
        ...
        label = Text("四次贝塞尔曲线", font="Source Han Serif SC").scale(1.8).set_color(BLACK).shift(DOWN * 3)
        self.add(label)
        self.add(P, P_lines)
        self.add(Q, Q_lines)
        self.add(R, R_lines)
...
class FifthOrderBezierCurve(Scene):
    ...
    def construct(self):
        ...
        label = Text("五次贝塞尔曲线", font="Source Han Serif SC").scale(1.8).set_color(BLACK).shift(DOWN * 3)
        self.add(label)
        self.add(P, P_lines)
        self.add(Q, Q_lines)
        self.add(R, R_lines)
